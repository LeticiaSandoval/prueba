...
<html>
    ...
    <body>
        ...
        <div id="show-articulos" class="content scaffold-show" role="main">
            ...
            <f:display bean="articulos" />
            <g:form resource="${this.articulos}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.articulos}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
